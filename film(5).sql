...
--
-- Host: localhost
-- Generation Time: Jun 21, 2023 at 02:16 PM
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `confirm_password`, `nama`, `level`) VALUES
(9, 'nadif@gmail.com', 'nadifmohede', '12345', '12345', 'Nadif Rayhan Julio Mohede', 'admin'),
(10, 'syahrul@gmail.com', 'syahrulyuda', '$2y$10$sJqYE5IO9ZTMehAO3p8B3u5mBhWZDvHntTH4hIfFui.GWw3OYwUVu', '$2y$10$ECmWcwWaNSQRtb.y7U.t/OJCbR5Xgt1MNy5CDvXV/bm5rElcuJt86', 'Syahrul Yuda', 'user'),
(11, 'deby@gmail.com', 'debydeby', '$2y$10$NRG/.z/c9p2sdmn20Q0kRO6YxQrGA4EICLJ2v2Sj1RTI67s.o8.u6', '$2y$10$EMXhaaY8XZLboYIKE5GU0eQFjg43b3yYY65k4jd2l8LWOGVLLMG0y', 'Deby Setianengsih', 'user'),
(12, 'bagas@gmail.com', 'andhitabagas', '$2y$10$Uq7jO.ATiG/MR5WOPvjJr.yDBrlPck14tdjfgZ09kNc9T//syLxw6', '$2y$10$9r/bEuk.zUmz/SxbtzCml.lJdiq/KKhywkI4IV5T226njf3YZ7tha', 'Andhita Bagas', 'user'),
(14, 'julio123@gmail.com', 'juliojulio', '12345', '12345', 'Julio Rayhan', 'user');
...
--
ALTER TABLE `reviewer`
  MODIFY `id_reviewer` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
